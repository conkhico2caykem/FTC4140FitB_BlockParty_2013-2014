...
#include "BlockPartyIncludes.c" //Gets include file for commands like gyro turn and gyro straght
...
task main()
{
  ...
  MFD(26,100,1000000); //takes the robot to the teeter totter
  ...
  MFD(28,100,10000000); //Drives us onto the bridge
  GyroRight(42, 100000000); // turns 45 degrees right to put us parrallel to ramp
}
