...
task main()
{
  ...
  servo[scoopL] = 200;
	...
	if(_dirAC > 5)    //check zone 1
	{
		...
		servo[scoopL] = 255;
		servo[scoopR] = 0;
		//code to back up onto our ramp
		MFD(16, 100, 1000000);
		wait10Msec(10);
		GyroRight(39, 10000000);
		wait10Msec(10);
		MFD(16, 100, 100000000);
		wait10Msec(10);
		GyroRight(35, 1000000000);
		wait10Msec(10);
		MFD(26, 100, 100000000);
		wait10Msec(10);
		GyroRight(88, 1000000);
		wait10Msec(10);
		MFD(38, 100, 1000000000);
