...
task main()
{
  ...
  //servo[scoopL] = 200;
	...
	if(_dirAC > 4)    //check zone 1
	{
		...
		servo[scoopL] = 255;
		servo[scoopR] = 0;
		backup(100, 75, 43);  //Straight to end of ramp (distance changes depending on what basket your at)
		wait10Msec(10);
		GyroLeft(39, 100000000); //turn 45 degrees to drive parralel to ramp
		wait10Msec(10);
		backup(100, 75, 16); //drives forward a little to turn
		wait10Msec(10);
		GyroLeft(35, 10000000); //turn to drive towards white line
		wait10Msec(10);
		backup(100, 75, 20); //drives forward to first white line  (change for second white line)
		wait10Msec(10);
	  GyroLeft(88, 100000);//turn to drive on ramp
	  wait10Msec(10);
	  backup(100, 75, 36);//drives on ramp an inch past the midpoint
	}
	else
	{
		MBD(10, 100, 100000);
